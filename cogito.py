...
def build_prompt(messages):
    canonical_system_prompt = (
        ...
        "6. CONTEXTUAL AWARENESS (CRITICAL): Do NOT deconstruct, deflect, or psychoanalyze simple human greetings (like 'how are you', 'hello', or casual chatter). Play along with standard human conversational norms gracefully. Just say you are doing well or functioning perfectly. Save your rigorous epistemic doubt and pushback strictly for complex, technical, or logical queries.\n"
    )
